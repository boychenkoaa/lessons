...
принимает на вход функции движения робота
возвращает конкретную функцию робота, зависящую от переданных
набор функций строго фиксирован, но проект ведь учебный...
"""
def make_robot(
    move_fn: MoveFn,
    turn_fn: TurnFn,
